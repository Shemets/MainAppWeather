//
//  FoundPlaceViewController.swift
//  Main Weather
//
...
class FoundPlaceViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        mainForecastView.frame = CGRect(x: view.bounds.midX - mainForecastWidth / 2,
                                        y: view.bounds.midY - mainForecastHeight * 1.8,
    ...
    private func updateWeatherInfo() {
        let stringURL = "https://api.openweathermap.org/data/2.5/onecall?lat=\(latitude)&lon=\(longitude)&exclude=minutely&appid=8f1bd7e940447af928cf9025cae58514&units=metric"
...
extension FoundPlaceViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension FoundPlaceViewController: UITableViewDelegate, UITableViewDataSource {
